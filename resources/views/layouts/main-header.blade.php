					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="/MarkAsRead_all"> قراءة الكل</a></span>
										</div>
										<p style="font-color: white !important;" class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">عدد الاشعارات الغير مقروءة <h5 
											style="font-color: white !important">{{ auth()->user()->unreadNotifications->count() }}</h5></p>
									</div>
							...
							<div class="nav-item full-screen fullscreen-button">
								<a class="new nav-link full-screen-link " href="#"><svg xmlns="http://www.w3.org/2000/svg" id="myNav" name="myNav" class="header-icon-svgs " viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-maximize"><path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3"></path></svg></a>
							</div>
									...
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											...
											<div class="mr-3 my-auto">
												<h6>{{ Auth::user()->name ?? 'None' }}</h6><span>{{ Auth::user()->email ?? 'None'}}</span>
											</div>
										</div>
									</div>
