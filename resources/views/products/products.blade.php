							...
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<div class="col-sm-6 col-md-3">
										<button class="btn btn-primary btn-block modal-effect" data-effect="effect-scale"
										data-toggle="modal" href="#exampleModal"> اضافة منتج +</button>
									</div>
								</div>								
							</div>
							<div class="card-body">
							...
							<div class="modal-content">
								...
								<form action="destroy" method="post">
									...
									<div class="modal-body">
										...
										<input class="form-control" name="product_name" id="product_name" type="text" value="	" readonly>
									</div>
									<div class="modal-footer">
