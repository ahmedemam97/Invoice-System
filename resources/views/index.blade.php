					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2">
								<div class="">
									<h4 class="mb-3 tx-12 text-white">اجمالى الفواتير</h4>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<!--sum of totals of invoices-->
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pr-3 pb-2 pt-0">
								<div class="">
									<h4 class="mb-3 tx-12 text-white">الفواتير الغير مدفوعة</h4>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<!--sum of totals of invoices-->
											<h4 class="tx-20 font-weight-bold mb-1 text-white">${{ number_format(\App\Models\Invoices::where('Value_Status' , '2')->sum('Total')) }}</h4>
											<!--sum of totals of invoices-->
											<p class="mb-0 tx-12 text-white op-7"> عدد الفواتير : {{ \App\Models\Invoices::where('Value_Status' , '2')->count() }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
						...
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">${{ number_format(\App\Models\Invoices::where('Value_Status', '1')->sum('Total')) }}</h4>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">عدد الفواتير : {{ \App\Models\Invoices::where('Value_Status', '3')->count() }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
																									<!--percent -->
