...
line-height: 1.3;
border-style: dashed;
border: 3px solid rgb(75, 36, 218);
                    ...
                    <div class="card-body">
                        <div class="invoice-header">
                            <div class="logo-header">
                                ...
                                <img src="{{ URL::asset('assets\img\3d-illustration-payment-confirmation-bill.jpg') }}"
                                 class="avatar brround logo-img" alt="">
                            </div>
                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="tx-right tx-uppercase tx-bold tx-inverse"><strong class="total-invoice">الاجمالي شامل الضريبة</strong></td>
