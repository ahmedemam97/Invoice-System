											...
											<tr>
												...
												<td>
													<a href="{{ url('/InvoicesDetails') }}/{{ $invoice->id }}">
														{{ $invoice->section->section_name }}   {{-- section ==>> the name of relation in Invoice model --}}
													</a>										{{-- to get the name of section from sections table and display it in the table page --}}
												</td> 									
												<td>{{ $invoice->Due_date }}</td>			    
